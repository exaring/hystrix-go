...
[![GoDoc Documentation](http://godoc.org/github.com/exaring/hystrix-go/hystrix?status.png)](https://godoc.org/github.com/afex/hystrix-go/hystrix)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/exaring/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/exaring/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/exaring/hystrix-go```
- ```go test ./...```
